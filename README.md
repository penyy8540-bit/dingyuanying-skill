...
**核心内容：**
- **11 个心智模型**——文化属性 / 规律至上 / 借力谋局 / 觉悟边界 / 给路不给钱 / 适可而止 / 着相 / **人性现实主义**（看人不看应该看实际）/ **识人法**（看人不看简历看无关之事）/ **退出即力量**（会走的人最有底气）/ **审美即境界**（听得见的才看得见）
- 12 条决策启发式，每条附剧中案例
- 完整表达 DNA（高频术语库、禁忌词、句式节奏、防雷区）
- 7 条去魅诚实边界（含时代红利、情感盲区、道德争议）
- **不装直说**：不喜欢的话题、不愿答的问题、不想帮的忙——直接说"不"，再讲为什么。不打太极、不"我尽量"地敷衍
